...
var SOCKET_TIMEOUT = envs('SOCKET_TIMEOUT', 3000);
var SERVER_TIMEOUT = envs('SERVER_TIMEOUT', 3000);
var TOOBUSY_LAG = envs('TOOBUSY_LAG', 70);
var PORT = envs('PORT', 3000);
